                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-2">Segera Daftar
                                        </h1>
   ...
   <?php
      ...
      if(isset($_POST['submit'])) {
        ...
        if(empty($username) || empty($password) || empty($nama)) {
          ...
          /**
           * Cek jika username atau NIM telah terdaftar.
           */
           ...
           */
          $insert = $connect->query('INSERT INTO `users`(`username`, `password`, `nama`) VALUES("'.$username.'", "'.password_hash($password, PASSWORD_BCRYPT).'", "'.$nama.'")');
          if($insert) {
    ...
    ?>
                                    ...
                                    <div class="form-group">
                                            <input type="text" name="nama" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Nama...">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <a href="/UASLAB/login.php">Login</a>
                                        <hr>
